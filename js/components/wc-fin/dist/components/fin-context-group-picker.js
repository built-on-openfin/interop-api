...
const ContextGroupPicker = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["fin-context-group-picker"];
  components.forEach(tagName => { switch (tagName) {
    case "fin-context-group-picker":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContextGroupPicker);
      }
      break;
  } });
}

const FinContextGroupPicker = ContextGroupPicker;
const defineCustomElement = defineCustomElement$1;

export { FinContextGroupPicker, defineCustomElement };

//# sourceMappingURL=fin-context-group-picker.js.map